...
class ExperienceAnalytics:
    ...
    def __init__(self, xdr_data):
        ...
        self.xdr_data['TCP DL Retrans. Vol (Bytes)'] = pd.to_numeric(self.xdr_data['TCP DL Retrans. Vol (Bytes)'], errors='coerce')
        self.xdr_data['Avg RTT DL (ms)'] = pd.to_numeric(self.xdr_data['Avg RTT DL (ms)'], errors='coerce')
        self.xdr_data['Avg Bearer TP DL (kbps)'] = pd.to_numeric(self.xdr_data['Avg Bearer TP DL (kbps)'], errors='coerce')
